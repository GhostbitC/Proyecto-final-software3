...
public class AdministradorServicioTest {
    ...
    public void registrarAdministradorTest(){
        ...
        try {
            ...
            Administrador registrado = administradorServicio.registrarAdministrador(a);
    ...
    public void eliminarAdministradorTest(){
        ...
        try {
            ...
            administradorServicio.eliminarAdministrador(a.getEmail());

            Administrador eliminado = administradorServicio.obtenerAdministrador(1);
    ...
    @Test
    @Sql("classpath:dataset.sql")
    public void obtenerAdministradorEmailTest(){

        try {
            Administrador a = administradorServicio.obtenerAdministradorEmail("braianc.piedrahitar@uqvirtual.edu.co");
